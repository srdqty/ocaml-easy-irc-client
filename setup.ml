...
(* OASIS_START *)
(* DO NOT EDIT (digest: f9dfe9751f6fe5c3d51de328fb0333e4) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Easy_irc_client"];
                      lib_pack = false;
                      lib_internal_modules = ["Message_util"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "easy-irc-client";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "api-easy-irc-client";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "API reference for easy-irc-client";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\140H{\249\186\231\170\245y\024\0193\161P\174\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
